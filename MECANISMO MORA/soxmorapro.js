...
`TITULAR TOMA PAGO MORA DE CONTADO PARA EL PRODUCTO ${producto} CUYO PAGO MINIMO A LA FECHA ES DE ${pagoMinimo} DE LOS CUALES SE LE GENERARA UNA BAJA EN CUENTA DE INTERES MORATORIO DEL ${descIntMora} %, DE INTERES CORRIENTE DE ${descIntCte}% Y BAJA EN CUENTA TOTAL DE ${descTotal} DANDO COMO ABONO A PAGAR UN MONTO DE ${pagoSNR} EFECTIVO OFICINAS BANCO DE BOGOTA Y AL SNR SE LE INFORMA DE POLITICAS Y CONDICIONES ESTA DE ACUERDO. SE LE INFORMA NEGOCIACION SUJETA A VERIFICACION, APROBACION O NEGACION POR PARTE DEL BANCO. SE RECUERDA BLOQUEO DE PRODUCTOS CON CUPO POR 120 DIAS`;
